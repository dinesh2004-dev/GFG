<h2><a href="https://www.geeksforgeeks.org/problems/check-for-bst/1?page=1&company=FactSet&sortBy=submissions">Check for BST</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given the <strong>root</strong> of a binary tree. Check whether it is a BST or not.<br></span></p>
